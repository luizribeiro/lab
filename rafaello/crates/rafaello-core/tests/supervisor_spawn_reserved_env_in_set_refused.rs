//! c16 SP4 Phase A step 4 — `env.set` keys equal to one of
...
#[tokio::test]
async fn spawn_with_reserved_env_in_set_returns_reserved_env_in_plan() {
    for &reserved in RESERVED {
        ...
        env_set.insert(reserved.to_string(), "x".to_string());
