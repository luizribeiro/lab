//! Provider publishing `provider.mock.assistant_message` without an
//! `in_reply_to` field is rejected as `InvalidInReplyTo { Missing }`
//! (scope §B6 step 7, c10).
...
#[test]
fn assistant_message_missing_in_reply_to_rejected() {
